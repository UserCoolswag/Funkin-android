...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false, ?fromCache:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-pixel':
				noteSkin = 'bf';
				var tex = Paths.getSparrowAtlas('characters/bfPixel', 'shared');
				frames = tex;

				trace(tex.frames.length);

				animation.addByPrefix('idle', 'BF IDLE instance', 24, false);
				animation.addByPrefix('singUP', 'BF UP instance', 24, false);
				animation.addByPrefix('singLEFT', 'BF LEFT instance', 24, false);
				animation.addByPrefix('singRIGHT', 'BF RIGHT instance', 24, false);
				animation.addByPrefix('singDOWN', 'BF DOWN instance', 24, false);
			...
			case 'bf-pixel':
				var tex = Paths.getSparrowAtlas('characters/bfPixelsDEAD', 'shared');
				frames = tex;
			...
			case 'elyo':
				iconColor = "FFd73c92";
				noteSkin = 'elyo';
				frames = Paths.getSparrowAtlas('characters/extra/Elyo', 'shared');
				animation.addByPrefix('idle', 'Elyo idle dance', 24, false);
				animation.addByPrefix('singUP', 'Elyo Sing Note UP', 24, false);
				animation.addByPrefix('singDOWN', 'Elyo Sing Note DOWN', 24, false);
				animation.addByPrefix('singLEFT', 'Elyo Sing Note LEFT', 24, false);
				animation.addByPrefix('singRIGHT', 'Elyo Sing Note RIGHT', 24, false);
				animation.addByPrefix('drop', 'Elyo drop', 24, false);
			...
			case 'liza':
				iconColor = "FFF9CF51";
				noteSkin = 'liza';
				frames = Paths.getSparrowAtlas('characters/extra/Liza_Assets', 'shared');
				animation.addByPrefix('idle', 'Liza dance', 24, false);
				animation.addByPrefix('singUP', 'Liza up', 24, false);
				animation.addByPrefix('singDOWN', 'Liza down', 24, false);
				animation.addByPrefix('singLEFT', 'Liza left', 24, false);
				animation.addByPrefix('singRIGHT', 'Liza right', 24, false);
